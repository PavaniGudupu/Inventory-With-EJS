...
//Join, it has both prod and category data. passing array and rendering as array.cated
app.get("/products", async (req, res) => {
  try {
    ...
    res.render("productList.ejs", { products: productsRes.rows, categories: categoriesRes.rows });
  } catch (error) {
...
app.post("/products/add", id_Validation, field_Validation, async (req, res) => {
  try {
   ...
   // returns all rows
    ...
    res.render("productList", { products: allProducts.rows });
